...
public class Test {
	...
	public static List<StudentDetails> insertRecords() {
		...
		student1.setStudentPhoneNumber(789654123);
		list.add(student1);
		// Record 2
		...
		student2.setStudentPhoneNumber(789654123);
		list.add(student2);
		// Record 3
		...
		student3.setStudentPhoneNumber(789654123);
		list.add(student3);
		// Record 4
		...
		student4.setStudentPhoneNumber(789654123);
		list.add(student4);
		// Record 5
		...
		student5.setStudentPhoneNumber(789654123);
		list.add(student5);
		// Record 6
		...
		student6.setStudentPhoneNumber(789654123);
		list.add(student6);
		// Record 7
		...
		student7.setStudentPhoneNumber(789654123);
		list.add(student7);
		// Record 8
		...
		student8.setStudentPhoneNumber(789654123);
		list.add(student8);
